...
<title>Web Development || FEEDBACK </title>
...
<div class="col-lg-6">
<span class="logo">TCS iON</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:destinyofyash@gmail.com" style="color:#000000">destinyofyash@gmail.com</a><br /><br />
...
<a href="https://destinyofyash.business.site/" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Yash Vardhan Singh" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://destinyofyash.business.site/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Yash Vardhan Singh</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 6394729807</h4>
		<h4 style="font-family:'typo' ">destinyofyash@gmail.com</h4>
		<h4 style="font-family:'typo' ">City College of Management, Lucknow University</h4></div></div>
		</p>
      </div>
